...
export const Swap: React.FC = () => {
  const TOKEN_ADDRESSES = {
    SDT: "0xc63d45EE9D7956eD46A22e6707c86b14C8e8422a",
    SKT: "0x7B45B03Eb6dcC189358F8cF3f317E318bb99c704",
  };

  const TOKENSWAP_CONTRACT_ADDRESS =
    "0x425a6c50173Bd7e71D279a8E4f042C9DcBfCAac1";
  ...
  useEffect(() => {
    async function calculateSwapAmount() {
      ...
      try {
        ...
        const expectedAmount = await contract.getSwapAmount(
